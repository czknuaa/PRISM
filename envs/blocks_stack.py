...
class blocks_stack(Base_task):
    ...
    def move_block(self,actor,id = 0, las_arm = None):
        ...
        if actor_pose[0] >0:
            ...
            pose1[2] += 0.05
            self.right_move_to_pose_with_screw(pose1)
            target_pose = [0.01,-0.097,0.95 + id * 0.05,-0.5,0.5,-0.5,-0.5]
            self.right_move_to_pose_with_screw(target_pose)
            target_pose[2] -= 0.04
            self.right_move_to_pose_with_screw(target_pose)
            ...
            pose1[2] += 0.05
            self.left_move_to_pose_with_screw(pose1)
            target_pose = [0,-0.1,0.95 + id * 0.05,-0.5,0.5,-0.5,-0.5]
