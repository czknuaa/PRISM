...
from prism.model.diffusion.conv1d_components import (
    Downsample1d, Upsample1d, Conv1dBlock)
from prism.model.diffusion.positional_embedding import SinusoidalPosEmb
...
class ConditionalResidualBlock1D(nn.Module):
    ...
    def __init__(self,
        ...
        #卷积两次  in-chan -> out-chan , out-chan -> out-choan
    ...
    def forward(self, x, cond=None):
        ...
        '''
        #BXin_chanXH -> BXout_chanXH
        out = self.blocks[0](x)    #将x传递给blocks的第一个模块  in-chan -> out->chan
        if cond is not None:      
            if self.condition_type == 'film':
                ...
                embed,_ = self.cond_encoder(x.permute(0, 2, 1), cond)
...
class ConditionalUnet1D(nn.Module):
    ...
    def forward(self, 
        ...
        """
        sample = einops.rearrange(sample, 'b h t -> b t h') #reshape sample  BX14X8
        #sample就是trajc
        ...
        if global_cond is not None:
            ...
            #timestep_embed  BX64   global_cond BX576 (BX(3X192))
