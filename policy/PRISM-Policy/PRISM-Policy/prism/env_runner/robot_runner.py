...
import prism.common.logger_util as logger_util
...
class RobotRunner(BaseRunner):
    ...
    def get_action(self, policy: BasePolicy, observaton=None) -> bool: # by tianxing chen
        ...
        with torch.no_grad():
            ...
            obs_dict_input['agent_pos'] = obs_dict['agent_pos'].unsqueeze(0)  #1Xobs_stepX14 1x3x14
            obs_dict_input['point_label'] = obs_dict['point_label'].unsqueeze(0)
